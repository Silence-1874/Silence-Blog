<template>
    ...
    <div>
        ...
        <h3 class="ui dividing header">Comments | 共 {{ allComment }} 条评论</h3>
        ...
        <div class="comment" v-for="comment in comments" :key="comment.id">
            ...
            <div class="content">
                <div class="nickname">
                    {{ comment.nickname }}
                    <div class="ui red left pointing label" v-if="comment.isAdmin">博主</div>
                </div>
                <div class="metadata">
            ...
            <div class="comments" v-if="comment.replyComments.length > 0">
                <div class="comment" v-for="reply in comment.replyComments" :key="reply.id">
                    ...
                    <div class="content">
                        <div class="nickname" >
                            {{ reply.nickname }}
                            <div class="ui red left pointing label" v-if="reply.isAdmin">博主</div>
                        </div>
                        <div class="metadata">
